...
python lstm_optimize.py "OptStudy_LMT" 50 & #1 
python lstm_optimize.py "OptStudy_v1" 20 & #"2
python lstm_optimize.py "OptStudy_v2" 20 & #3
python lstm_optimize.py "OptStudy_v3" 20 & #4
wait
